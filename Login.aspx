<%@ Page Title="" Language="C#" MasterPageFile="~/User/Usermaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Job_Online_Portal.User.Login" %>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="User type  is required"
                    ...
                    ControlToValidate="ddlLoginType"></asp:RequiredFieldValidator>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <span class="clickLink"><a href="../User/Register.aspx"> do you want to Register? click here..</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
