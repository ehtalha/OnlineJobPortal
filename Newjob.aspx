<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Newjob.aspx.cs" Inherits="Job_Online_Portal.Admin.Newjob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12 pt-3">   
        ...
        <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control" placeholder="Enter Job Description" TextMode="MultiLine" required>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">   
    <div class="col-md-6 pt-3">   
        <label for="txtQualification" style="font-weight: 600">Education Required </label>
        <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. BCS in CSE" required>
        </asp:TextBox>
    </div>
    <div class="col-md-6 pt-3">   
        <label for="txtExperience" style="font-weight: 600">Experience Required </label>
        <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex. no experience, 1 years" required>
        </asp:TextBox>
    </div>
</div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">   
    <div class="col-md-6 pt-3">   
        <label for="txtSpecialization" style="font-weight: 600">Spacialization Required </label>
 ...
 <div class="row mr-lg-5 ml-lg-5 mb-3">   
    <div class="col-md-6 pt-3">   
        ...
        <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex. 50,000tk only"  required>
        </asp:TextBox>
    </div>
    <div class="col-md-6 pt-3">   
 ...
 <div class="row mr-lg-5 ml-lg-5 mb-3">   
    <div class="col-md-6 pt-3">   
        ...
        <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder="Enter Company Name"  required>
        </asp:TextBox>
    </div>
    <div class="col-md-6 pt-3">   
        <label for="ddlJobType" style="font-weight: 600">Company Name Logo</label>
       <asp:FileUpload ID="fuCompanyLogo" runat="server" CssClass="form-control" ToolTip=".jog, .jpeg, .png extension only" />
    </div>
</div>
 ...
 <div class="row mr-lg-5 ml-lg-5 mb-3">   
    <div class="col-md-6 pt-3">   
        ...
        <asp:TextBox ID="txtWebsite" runat="server" CssClass="form-control" placeholder="Enter Company Website" TextMode="Url">
        </asp:TextBox>
    </div>
    <div class="col-md-6 pt-3">   
